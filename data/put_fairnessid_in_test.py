...
# 加载数据集
mapping_data = pd.read_csv("./a0910/origin_with_group_updated.csv")
test_data = pd.read_csv("./a0910/test.csv")
...
# 保存到文件
test_data.to_csv("./a0910/test_with_fairness_id_origin.csv", index=False)
