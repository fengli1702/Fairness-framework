...
valid_data = pd.read_csv("../data/test/test_finial.csv")
test_data = pd.read_csv("../data/test/test_finial.csv")
...
# 提取用户能力参数
cdm.extract_ability_parameters(test_fairness, filepath="v_ability_parameters.csv",eval_data=test_set, device="cuda")    